...
export const Attribution = (): JSX.Element => {
    return (
        <React.Fragment>
            <Text fontSize="xs">This application is a proof of concept to showcase IBM Watson Tone Analyzer: the data presented should not be used to make any decisions and further research should be performed to determine conclusions from displayed information.</Text>
            <br/>
